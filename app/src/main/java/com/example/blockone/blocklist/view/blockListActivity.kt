package com.example.blockone.blocklist.view
...
import com.example.blockone.blockdetails.view.blockDetailFragment

import com.example.blockone.dummy.DummyContent
import kotlinx.android.synthetic.main.activity_block_list.*
import kotlinx.android.synthetic.main.block_list_content.view.*
...
class blockListActivity : AppCompatActivity() {
    ...
    class SimpleItemRecyclerViewAdapter(
        private val parentActivity: blockListActivity,
                ...
                if (twoPane) {
                    val fragment = blockDetailFragment().apply {
                        arguments = Bundle().apply {
                            putString(blockDetailFragment.ARG_ITEM_ID, item.id)
                        }
                    }
                    ...
                    val intent = Intent(v.context, blockDetailActivity::class.java).apply {
                        putExtra(blockDetailFragment.ARG_ITEM_ID, item.id)
                    }
